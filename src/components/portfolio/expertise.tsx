              ...
              <div key={expert.id} className="w-full md:w-1/2 xl:w-1/4 px-4">
                <div className="bg-primary shadow-service py-10 px-8 rounded-xl relative z-10 overflow-hidden text-center duration-200 mb-8">
                  ...
                  />
                    ...
                    <Image alt='frontend' width="35" height="33" src={`https://portfolio-server.services.divvit.co/assets/${expert.icon}`} />
                    {/* {expert.icon} */}
                  </div>
                  <h3 className="font-bold  text-xl sm:text-2xl lg:text-xl 2xl:text-2xl text-white mb-3">{expert.title}</h3>
                  <p className="font-medium text-body-color text-white leading-relaxed text-sm">{expert.skills}</p>
                  <div>
