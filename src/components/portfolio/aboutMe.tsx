interface AboutMeProps {
  tagLine: string;
  shortBio: string;
  shortCareerDescription: string;
}

const AboutMe: React.FC<AboutMeProps> = ({ tagLine, shortBio, shortCareerDescription }) => (
    ...
    <div className="container">
      <div className="flex flex-wrap mx-[-16px]">
        <div className="w-full lg:w-1/2 xl:w-7/12 px-4 mb-8 lg:mb-0">
          <span className="font-bold text-primary text-lg md:text-xl mb-3"> ABOUT ME </span>
        ...
        <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
          <h3 className="font-semibold text-black text-2xl md:text-3xl mb-6">Connect With Me</h3>
